package com.worthen.cody.springwebapp.bootstrap;
...
import com.worthen.cody.springwebapp.repositories.PublisherRepository;
...
public class BootStrapData implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		publisher.setAddressLine1("123 S. Bridgeport Parkway");
		publisher.setName("SFG Publishing");
		publisher.setCity("St Petersburg");
		publisher.setState("FL");
		publisher.setZip("55666");
		...
		Book noEJB = new Book("J2EE", "7774321");
